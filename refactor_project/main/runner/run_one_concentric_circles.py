...
from refactor_project.data.concentric_circles import FEATURE_NAMES, load_concentric_circles_pool
...
def _run_one_seed_concentric_circles(
    seed: int,
    nq: int,
    sc_name: str,
    sc_tag: str,
    ...
    uma combinação (seed, nq) do dataset Círculos Concêntricos.
    """
    ...
    X_full, Y_full = load_concentric_circles_pool(
