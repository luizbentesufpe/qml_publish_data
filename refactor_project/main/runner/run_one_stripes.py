...
from refactor_project.data.stripes import FEATURE_NAMES, load_stripes_pool_flatten
...
def _run_one_seed_stripes(
    ...
    uma combinação (seed, nq) do dataset Stripes.
    """
    ...
    X_full, Y_full = load_stripes_pool_flatten(
